...
import com.itbulls.learnit.openai.entities.functions.impl.GetCurrencyExchangeFeesFunction;
import com.itbulls.learnit.openai.entities.functions.impl.GetGeneralTradingInformationFunction;
import com.itbulls.learnit.openai.entities.functions.impl.GetRisksFunction;
import com.itbulls.learnit.openai.entities.functions.impl.GetTradingFeesFunction;
...
//			@Value("${gpt.function.jira.create.issue.attr.duedate.format}") String dueDateFormat,
...
//	}
	...
	@Bean("getCurrencyExchangeFeesFunction")
	public Function getCurrencyExchangeFeesFunction() {
		return new GetCurrencyExchangeFeesFunction();
	}
	
	@Bean("gptCurrencyExchangeFeesFunction")
	public GptFunction gptRevolutCurrencyExchangeFeesFunction(@Value("${gpt.function.revolut.get.currency.exchange.fees.name}") String functionName,
			@Value("${gpt.function.revolut.get.currency.exchange.fees.description}") String description) {
		var function = new GptFunction();
		function.setName(functionName);
		function.setDescription(description);
		GptFunction.Parameters parameters = function.new Parameters();
	...
	@Bean("getGeneralTradingInformationFunction")
	public Function getGeneralTradingInformationFunction() {
		return new GetGeneralTradingInformationFunction();
	}
	
	@Bean("gptGeneralTradingInformationFunction")
	public GptFunction gptGeneralTradingInformationFunction(@Value("${gpt.function.revolut.get.trading.name}") String functionName,
			@Value("${gpt.function.revolut.get.trading.description}") String description) {
		var function = new GptFunction();
		function.setName(functionName);
		function.setDescription(description);
		GptFunction.Parameters parameters = function.new Parameters();
	...
	@Bean("getTradingFeesFunction")
	public Function getTradingFeesFunction() {
		return new GetTradingFeesFunction();
	}
	
	@Bean("gptTradingFeesFunction")
	public GptFunction gptTradingFeesFunction(@Value("${gpt.function.revolut.get.trading.fees.name}") String functionName,
			@Value("${gpt.function.revolut.get.trading.fees.info}") String description) {
		var function = new GptFunction();
		function.setName(functionName);
		function.setDescription(description);
		GptFunction.Parameters parameters = function.new Parameters();
